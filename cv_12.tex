...
{jayanthkaturi72@gmail.com} | +91-8985747647 % Your contact information
}
...
\textbullet{} Kubernetes \textbullet{} AWS EC2/S3 \textbullet{} Blender 
\textbullet{} Django \textbullet{} flask \textbullet{} Ionic \textbullet{} Unity 3D
\textbullet{} Kali Linux (pen testing) \textbullet{} Matlab \textbullet{} tex ... \\
...
\textbullet{}Computer Science (B Tech + MS)  \\
...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
\item Develope/Primary Maintainer for our team's code base (React-Redux UI + Python backend), some Ops tasks, co-ordinating with other teams for various aspects and other maintainance aspects.
...
\item \descript{Compiler for Decaf using flex and bison}
\end{tightitemize}
