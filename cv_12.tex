...
\item \descript{NGINX auth proxy} A python-flask based application for authentication of all services using nginx server. {\footnotesize \textit{\textbf{\href{https://github.com/jayanthkaturi/nginx-auth-proxy}{Github Link}}}}
